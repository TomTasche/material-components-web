...
MDC Toolbar provides a multiple row container for application navigation, title
and tabs. Toolbars scroll with content by default, but supports fixed on
...
You can wrap second row such as mdc-tabs within mdc-toolbar:
